  ...
  return (
    ...
    style={{ backgroundImage: `url(${bgShadow})` }}
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        ...
        <h1 className='text-3xl font-semibold text-center'>Assemble Your Ultimate Dream 11 Cricket Team</h1>
        <p className='text-2xl'>Beyond Boundaries Beyond Limits</p>
        <button className='bg-amber-500 px-6 py-2 rounded-md cursor-pointer font-semibold mt-10'> Claim Free Credit</button>
      </div>
</div>
